...
namespace _08._09._2023_dzz
{
    public partial class Form1 : Form
    {
        ...
        private void t_Tick(object sender, EventArgs e)
        {
            ...
            g.DrawLine(new Pen(Color.DeepSkyBlue, 4f), new Point(cx, cy), new Point(handCoord[0], handCoord[1]));

            handCoord = msCoord(m, minHAND);
            g.DrawLine(new Pen(Color.DeepSkyBlue, 2f), new Point(cx, cy), new Point(handCoord[0], handCoord[1]));
